...
- 国数は90固定。
- 大国と小国が混在するよう、国ごとの勢力重みを偏らせて割り当てる。
- 地形追従を強めるため、山地・斜面・海岸距離をコストに含めて領域分割する。
- 生成のたびに国境を再計算し、同一seedでは再現される。

## TODO
- [x] 段階1を実装
- [x] 段階2の実装
- [x] 段階3を実装
- [x] 1回の生成が重たくなってきた。ステップごとに描画し、進捗バーを置くことで体感時間を少なく
- [x] 国境の作成（自動生成）
